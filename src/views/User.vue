<template>
  <div class="container py-5">
    <UserProfileCard 
      :inital-user="user"
      :is-current-user="userId === user.id"/>
    <div class="row">
      <div class="col-md-4">
      ...
      <div class="col-md-8">
        ...
        <UserFavoritedRestaurantsCard :favoriteRestaurants="user.favoriteRestaurants"/>
      </div>
    </div>
  </div>
</template>
...
export default {
  name: 'User',
  components: {
    UserProfileCard,  UserFollowingsCard, UserFollowersCard, UserCommentsCard, UserFavoritedRestaurantsCard
  },
  data() {
    return {
      user: {
  ...
  methods: {
    fetchUser(userId) {
      console.log(userId)
      const {id, name ,email, isAdmin, image, Comments, FavoritedRestaurants, Followers, Followings} = dummyData.profile
      this.isFollowed = dummyData.isFollowed
      this.userId = dummyData.profile.id
      this.user = {
        id, name, email, isAdmin, image,
